...
attr_sa = compute_attributions(saliency, X_tensor, target=y_tensor)
visualize_attr_maps('visualization/saliency_map_captum.png', X, y, class_names,
                    [attr_sa], ['Saliency Map Captum'])
