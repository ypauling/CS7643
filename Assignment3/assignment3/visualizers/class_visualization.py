...
class ClassVisualization:
    ...
    def create_class_visualization(self, target_y, class_names, model, dtype, **kwargs):
        ...
        for t in range(num_iterations):
            ...
            ox, oy = random.randint(
                0, max_jitter), random.randint(0, max_jitter)
            ...
            dl2 = 2.0 * l2_reg * img_var.data
            dimg = img_var.grad.data - dl2
            ...
            if generate_plots:
                if t == 0 or (t + 1) % show_every == 0 or t == num_iterations - 1:
                    ...
                    plt.axis('off')
                    plt.savefig(
                        'visualization/class_visualization_iter_{}'.format(t + 1))
